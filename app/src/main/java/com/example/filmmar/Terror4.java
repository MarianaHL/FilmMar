...
public class Terror4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/terror%2FUn%20Lugar%20Tranquilo%20II%20(2020)%20Tr%C3%A1iler%20Oficial%20Espa%C3%B1ol.mp4?alt=media&token=e47bce2e-8242-4b72-8414-5cbe7502aacf");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("terror4").addValueEventListener(new ValueEventListener() {
            @Override
