...
public class Cf33 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/cienciaFiccion%2FVENOM%202-%20CARNAGE%20(2020)%20Woody%20Harrelson%20Movie%20-%20Trailer%20Concept%20(Fan%20Made).mp4?alt=media&token=a5b5a987-8d75-425e-a7ff-fdef3060be1c");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("cf3").addValueEventListener(new ValueEventListener() {
            @Override
