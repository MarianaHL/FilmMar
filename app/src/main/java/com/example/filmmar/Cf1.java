...
public class Cf1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/cienciaFiccion%2FLos%20nuevos%20mutantes%20(2020)%20Primer%20Tr%C3%A1iler%20Oficial%20Espa%C3%B1ol%20Latino.mp4?alt=media&token=18f7c39b-4d9f-481a-9689-c9a95cb4900a");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("cf2").addValueEventListener(new ValueEventListener() {
            @Override
