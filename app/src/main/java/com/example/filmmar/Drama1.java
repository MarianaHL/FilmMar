...
public class Drama1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/drama%2FLUCI%C3%89RNAGAS%20(2018)%2C%20dir.%20Bani%20Khoshnoudi%20-%20Clip%201.mp4?alt=media&token=80f52176-69c1-49c1-b771-72af04715e63");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("drama1").addValueEventListener(new ValueEventListener() {
            @Override
