...
public class Drama4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/drama%2FY%20llovieron%20pa%CC%81jaros%20-%20Trailer%20espan%CC%83ol%20(HD).mp4?alt=media&token=d17666c2-b0c9-4727-9875-069d1c64cafe");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("drama4").addValueEventListener(new ValueEventListener() {
            @Override
