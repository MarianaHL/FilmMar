...
public class Comedia2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/comedia%2FTodo%20pasa%20en%20Tel%20Aviv%20-%20Trailer%20espan%CC%83ol%20(HD).mp4?alt=media&token=72b302c4-e4dc-4d08-a568-8d1b396a9847");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("comedy4").addValueEventListener(new ValueEventListener() {
            @Override
