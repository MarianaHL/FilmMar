...
public class Animacion3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/animacion%2FKlara%20y%20el%20ladro%CC%81n%20de%20manzanas%20-%20Trailer%20espan%CC%83ol%20(HD).mp4?alt=media&token=0c498e5e-61fc-4450-88a9-9e638f70f5f2");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("animacion0").addValueEventListener(new ValueEventListener() {
            @Override
