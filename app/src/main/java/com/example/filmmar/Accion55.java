...
public class Accion55 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/accion%2FWonder%20Woman%201984%20%E2%80%93%20Official%20Trailer.mp4?alt=media&token=b64a6471-bbac-486d-b942-09144ecd171d");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("4").addValueEventListener(new ValueEventListener() {
            @Override
