...
public class Aventura33 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/aventura%2FJungle%20Cruise%20(2020)%20Disney%20Tr%C3%A1iler%20Oficial%20Espa%C3%B1ol%20Latino.mp4?alt=media&token=8ef4774b-f980-4cac-8a2d-37dee30e06cd");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("aven3").addValueEventListener(new ValueEventListener() {
            @Override
