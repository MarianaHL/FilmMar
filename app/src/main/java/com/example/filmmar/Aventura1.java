...
import com.example.filmmar.FragmentComedia;
...
public class Aventura1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/aventura%2FArtemis%20Fowl%20-%20Tr%C3%A1iler%20Oficial%20%232%20(Espa%C3%B1ol%20Latino).mp4?alt=media&token=d7c157a0-02e9-4d1b-8c18-76d24a87073b");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("aven1").addValueEventListener(new ValueEventListener() {
            @Override
