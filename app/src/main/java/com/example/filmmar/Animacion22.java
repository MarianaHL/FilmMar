...
public class Animacion22 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fr.replace(R.id.fragmentContainer,new FrameRecomendaciones());
                fr.commit();
            }
        });
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/animacion%2FBOB%20ESPONJA%202%20AL%20RESCATE%20Tr%C3%A1iler%20Espa%C3%B1ol%20Latino%20(2020)%20Keanu%20Reeves.mp4?alt=media&token=eb4e5296-184f-449b-a147-e80a2c02d24a");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("animacion2").addValueEventListener(new ValueEventListener() {
            @Override
