    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fr.replace(R.id.fragmentContainer,new FrameLista());
                fr.commit();
            }
        });
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/LEAKED%20MARVELS%20ETERNALS%20TRAILER%20(2020)%20FOOTAGE%20BREAKDOWN%20and%20RELEASE%20UPDATE.mp4?alt=media&token=b90fdc63-c892-4a0c-8f91-b9cd3f3a6674");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("lista1").addValueEventListener(new ValueEventListener() {
            @Override
