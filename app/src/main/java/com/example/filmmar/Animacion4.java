...
public class Animacion4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/animacion%2FMinions%202-%20Nace%20un%20Villano%20(2020)%20Tr%C3%A1iler%20Oficial%20Espa%C3%B1ol%20Latino.mp4?alt=media&token=891240c9-cb81-4514-868e-3b7f3721a842");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("animacion3").addValueEventListener(new ValueEventListener() {
            @Override
