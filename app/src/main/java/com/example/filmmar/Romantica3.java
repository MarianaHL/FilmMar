...
public class Romantica3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/romantica%2FLa%20belle%20%C3%A9poque%20-%20Trailer%20espa%C3%B1ol%20(HD).mp4?alt=media&token=7f040f86-409d-43b7-8052-70886a787791");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("roman3").addValueEventListener(new ValueEventListener() {
            @Override
