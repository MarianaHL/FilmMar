...
public class Terror2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/terror%2FOtra%20Vuelta%20De%20Tuerca%20(2020)%20Tr%C3%A1iler%20Oficial%20Espa%C3%B1ol.mp4?alt=media&token=9804b938-d38f-4937-a2d4-c6b7afe5f865");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("terror2").addValueEventListener(new ValueEventListener() {
            @Override
