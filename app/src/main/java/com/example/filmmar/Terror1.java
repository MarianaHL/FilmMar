...
public class Terror1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/terror%2FCandyman%20(2020)%20Tr%C3%A1iler%20Oficial%20Subtitulado.mp4?alt=media&token=7f130896-9053-48c7-8518-f8dc8c3bec23");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("terror1").addValueEventListener(new ValueEventListener() {
            @Override
