...
public class Animacion1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/animacion%2F%C2%A1SCOOBY!%20Tr%C3%A1iler%20Teaser%20Espa%C3%B1ol%20Latino%20(2020).mp4?alt=media&token=7e45f01b-d1e7-4694-b4a3-2954646e9f5c");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("animacion1").addValueEventListener(new ValueEventListener() {
            @Override
