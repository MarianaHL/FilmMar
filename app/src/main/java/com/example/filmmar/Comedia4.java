...
public class Comedia4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/comedia%2FTHE%20FRENCH%20DISPATCH%20-%20Official%20Trailer.mp4?alt=media&token=62cd6b9e-51a8-476a-9283-237edd149ca1");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("comedy3").addValueEventListener(new ValueEventListener() {
            @Override
