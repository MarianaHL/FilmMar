...
public class Drama3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/drama%2FThe%20Song%20of%20Names%20(La%20Canci%C3%B3n%20de%20los%20Nombres%20Olvidados)%20-%20Tr%C3%A1iler%20Oficial%20Subtitulado%20en%20Espa%C3%B1ol.mp4?alt=media&token=1a1c04a5-4747-44ee-9862-ae6de7948be1");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("drama3").addValueEventListener(new ValueEventListener() {
            @Override
