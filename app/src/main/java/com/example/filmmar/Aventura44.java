...
public class Aventura44 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/aventura%2FMUL%C3%81N%20Tr%C3%A1iler%20Espa%C3%B1ol%20Latino%20DOBLADO%20%23%203%20(Nuevo%2C%202020)%20SUPERBOWL.mp4?alt=media&token=81582408-8fe4-45bb-9070-f446d35d0a61");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("aven4").addValueEventListener(new ValueEventListener() {
            @Override
