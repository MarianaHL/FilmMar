...
public class Terror33 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/filmmar-f81e8.appspot.com/o/terror%2FSpiral-%20From%20the%20Book%20of%20Saw%20(2020)%20Tr%C3%A1iler%20Oficial%20Subtitulado.mp4?alt=media&token=8c141a46-dd91-42ca-86bf-b56892627f24");
        videoView.setVideoURI(uri);
        videoView.start();

        mDataBase = FirebaseDatabase.getInstance().getReference();
        mDataBase.child("terror3").addValueEventListener(new ValueEventListener() {
            @Override
